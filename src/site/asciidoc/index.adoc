...
`org.opengis.cite.wcps11`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.wcps11.level1.*

|Conformance Level 2
|org.opengis.cite.wcps11.level2.*
